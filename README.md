# BlueWallet - A Litecoin-PoS & Lightning Wallet
...
[![Playstore](https://bluewallet.io/img/play-store-badge.svg)](https://play.google.com/store/apps/details?id=org.litecoinpos.ltcpwallet)
...
I was not satisfied with existing iOS Litecoin-PoS apps, especially with BreadWallet (the one I mainly used) where development stalled and they could not even deliver such features as SegWit, RBF and custom fees (at the times where custom fees were especially needed).
